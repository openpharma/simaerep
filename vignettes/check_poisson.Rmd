...
df_visit1 <- boot_sim_test_data_study(
  n_pat = 1000,
  n_sites = 100,
...
df_visit1$study_roche <- "ae_per_visit: 0.5"

df_visit2 <- boot_sim_test_data_study(
  n_pat = 1000,
  n_sites = 100,
  frac_site_with_ur = 0.2,
  ur_rate = 0.5,
...
df_visit2$study_roche <- "ae_per_visit: 0.2"

df_visit3 <- boot_sim_test_data_study(
  n_pat = 1000,
  n_sites = 100,
  frac_site_with_ur = 0.2,
  ur_rate = 0.5,
...
df_visit3$study_roche <- "ae_per_visit: 0.05"
...
df_comp <- df_sim_sites %>%
  left_join(df_ecdf, by = "study_roche") %>%
