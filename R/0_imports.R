...
#' @importFrom stats p.adjust quantile median runif poisson.test ecdf rnorm rpois
#' @importFrom purrr safely pmap map map2 pmap_dbl map2_dbl map_dbl map_int map_chr
