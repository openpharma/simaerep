...
#' @title get emprical cumulative distribution values of pval or prob_lower
...
#' @param df_sim_sites dataframem, generated by [sim_sites()][sim_sites()]
...
#'   sites, patients and vist_med75 by bootstrap resampling, then probabilities
